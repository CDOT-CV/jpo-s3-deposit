...
import us.dot.its.jpo.ode.depositor.utils.CommonUtils;
...
public class DepositorProperties implements EnvironmentAware {
	...
	void initialize() {
	   ...
	   if (kafkaType != null) {
		...
		K_AWS_ACCESS_KEY_ID = CommonUtils.getEnvironmentVariable("AWS_ACCESS_KEY_ID", "AccessKeyId");
		K_AWS_SECRET_ACCESS_KEY = CommonUtils.getEnvironmentVariable("AWS_SECRET_ACCESS_KEY", "SecretAccessKey");
		K_AWS_SESSION_TOKEN = CommonUtils.getEnvironmentVariable("AWS_SESSION_TOKEN", "SessionToken");
		K_AWS_EXPIRATION = CommonUtils.getEnvironmentVariable("AWS_EXPIRATION", "Expiration");
		API_ENDPOINT = CommonUtils.getEnvironmentVariable("API_ENDPOINT", "");
		HEADER_Accept = CommonUtils.getEnvironmentVariable("HEADER_ACCEPT", "application/json");
